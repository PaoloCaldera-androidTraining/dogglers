...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView listItemAge, @NonNull TextView listItemHobby,
      @NonNull ImageView listItemImage, @NonNull TextView listItemName) {
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, listItemAge,
          listItemHobby, listItemImage, listItemName);
    }
